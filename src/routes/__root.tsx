...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "DichoLife Explorer" },
      { property: "og:description", content: "Jelajahi Dunia Keanekaragaman Hayati dan Temukan Identitas Setiap Organisme." },
